    ...
    <div className="min-h-[100dvh] w-full text-white overflow-x-hidden relative" style={{ backgroundColor: "#000000" }}>
      ...
      <div className="relative z-10 min-h-[100dvh] flex items-center justify-center">
        ...
        {/* Title and Description */}
          <div className="space-y-6">
            ...
            <div 
              className="mt-8 p-4 border border-white/10 rounded-sm max-w-md mx-auto"
              style={{
        ...
        {isConnected &&
          ...
          authState.step !== "username" && (
              <div 
                className="border border-white/10 rounded-sm p-6 max-w-md mx-auto"
                style={{
                  backgroundColor: "#000000",
                  opacity: 1,
                  backgroundImage: "linear-gradient(#131313 2px, transparent 2px), linear-gradient(90deg, #131313 2px, transparent 2px), linear-gradient(#131313 1px, transparent 1px), linear-gradient(90deg, #131313 1px, #000000 1px)",
        ...
        {authState.step === "username" && (
            ...
            <div className="space-y-4">
              ...
              {authState.username && !authState.error && (
                  <div className="bg-green-500/20 border border-green-500/50 rounded-sm p-3">
        ...
        {getCurrentError() && (
            <div 
              className="border border-red-500/50 rounded-sm p-4 max-w-md mx-auto"
              style={{
                backgroundColor: "#000000",
                opacity: 1,
                backgroundImage: "linear-gradient(#131313 2px, transparent 2px), linear-gradient(90deg, #131313 2px, transparent 2px), linear-gradient(#131313 1px, transparent 1px), linear-gradient(90deg, #131313 1px, #000000 1px)",
      ...
      {showOverlay && authState.step === "complete" && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div 
            className="text-white p-6 rounded-sm border border-white/20 max-w-md mx-4"
            style={{
              backgroundColor: "#000000",
              opacity: 1,
              backgroundImage: "linear-gradient(#131313 2px, transparent 2px), linear-gradient(90deg, #131313 2px, transparent 2px), linear-gradient(#131313 1px, transparent 1px), linear-gradient(90deg, #131313 1px, #000000 1px)",
          ...
          >
            <div className="text-center space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-lg font-mono bg-white/10 px-3 py-2 rounded-sm border">
                  {formatAddress(address || "")}
                </p>
                <p className="text-sm text-neutral-300 font-lexend">Your ENS Domain:</p>
                <p className="text-lg font-mono bg-green-500/20 px-3 py-2 rounded-sm border border-green-500/50 text-green-300">
